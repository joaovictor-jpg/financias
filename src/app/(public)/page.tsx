    ...
    <article className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          ...
          <InterfaceCard icon={<PieChart className='text-white'></PieChart>} title='Dashboard de Orçamento' description='Visualização completa de orçamentos e meta' buttonTitle='Visualizar Interface' rota='/dashboard' />
